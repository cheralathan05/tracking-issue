...
function CitizenLayoutContent({ initialUser }: { initialUser: AuthUser | null }) {
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-gradient-subtle">
      ...
      <div className="relative flex h-full min-h-0">
        <aside className="sticky top-0 hidden h-dvh w-72 shrink-0 flex-col border-r border-sidebar-border/80 bg-sidebar/95 text-sidebar-foreground backdrop-blur-xl md:flex">
        ...
        <div className="flex h-full min-h-0 min-w-0 flex-1 flex-col">
          ...
          <main
            className={`h-full flex-1 min-h-0 ${isChatRoute ? "overflow-hidden p-0" : "overflow-auto p-4 md:p-8"}`}
          >
            <Outlet />
          </main>
        </div>
